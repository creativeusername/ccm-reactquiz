...
ccm.components.reactquiz = {
  ...
  config: {
    ...
    data: [ ccm.create, { local: 'http://www.fh-lsoopjava.de/ccm/data/quiz.json' } ],
  },
  ...
  Instance: function () {
    ...
    self.render = function () {
      ...
      React.render( React.createElement(Quiz, {src: self.data.local}), self.element.find( '.quiz' )[ 0 ] );
    };
...
},{"./quiz.jsx":158}],158:[function(require,module,exports){
...
var Quiz = React.createClass({displayName: "Quiz",
        ...
        render: function () {
                ...
                React.createElement("div", {className: "col-md-6 col-md-offset-3"}, 
                  React.createElement("div", {className: "panel panel-default"}, 
                    React.createElement("div", {className: "panel-heading"}, 
                      React.createElement("span", null,  this.props.src.title), 
                      React.createElement("span", {className: "pull-right"}, " ", this.state.points)
                    ), 
                    ...
                    React.createElement("div", {className: "panel-footer"}, 
                      React.createElement("button", {className: "btn btn-success pull-right", onClick:  this._handleClick}, 
                         this._btnText() 
                      ), 
          ...
          var answerNodes = question.answers.map( function (answer, i) {
            return (
              React.createElement("li", {className: this._getColor(i), key: i}, 
                answer.text, 
                React.createElement("input", {className: "pull-right", type: "checkbox", 
              ...
              React.createElement("div", {className: "col-md-6 col-md-offset-3"}, 
                React.createElement("div", {className: "panel panel-default"}, 
                  ...
                  React.createElement("div", {className: "panel-body"}, 
                    ...
                    React.createElement("ul", {className: "list-group list-unstyled", key:  this.state.index}, 
                       answerNodes 
                    )
                  ), 
                  React.createElement("div", {className: "panel-footer"}, 
